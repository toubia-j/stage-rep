...
def evaluate_clustering(consommation_fr,binaire):
    """
...
########################################################### deep learning
"""
Entraînement et évaluation des modèles LSTM et CNN :
Les performances sont évaluées à l’aide des métriques  RMSE, MSE,MAE , R², CVRMSE 
"""
...
"""
Fonction prenant la température en entrée, et affichant la valeur réelle et prédite de la consommation énergétique.
"""
